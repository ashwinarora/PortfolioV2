const AfterHome = () => {
  return (
    <div className=" relative bg-lightmode dark:bg-black  flex items-center h-[40vh] md:h-[80vh] justify-center flex-col ">
      <div className=" m-8 mb-16 sm:m-16 lg:!mx-44 mt-16 moving-border1 dark:moving-border w-full ">
        <div className="bg-[#f0f0f0] dark:bg-black p-6 ">
      ...
      <img
        ...
        alt="Small Image 2"
        className="absolute left-12 top-[22rem] "
      />
      <img
